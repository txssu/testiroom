defmodule TestiroomWeb.CoreComponents do
  @moduledoc """
  ...
  attr :prompt_selected, :boolean, default: false, doc: "select prompt"
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        ...
        {@rest}
      >
        <option :if={@prompt} value="" disabled selected={@prompt_selected}><%= @prompt %></option>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestiroomWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestiroomWeb.Gettext, "errors", msg, opts)
    end
  end
