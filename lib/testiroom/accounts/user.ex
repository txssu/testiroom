defmodule Testiroom.Accounts.User do
  @moduledoc false
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Testiroom.Repo)
  ...
  def valid_password?(%Testiroom.Accounts.User{hashed_password: hashed_password}, password)
